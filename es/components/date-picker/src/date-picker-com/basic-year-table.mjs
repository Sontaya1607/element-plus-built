              ...
              (openBlock(), createElementBlock(Fragment, null, renderList(4, (__, j) => {
                return openBlock(), createElementBlock(Fragment, {
                  ...
                  i * 4 + j < 10 ? (openBlock(), createElementBlock("td", {
                    ...
                    createElementVNode("span", _hoisted_3, toDisplayString(unref(startYear) + i * 4 + j + unref(yearOffset)), 1)
...
var YearTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/sontayarungsaard/Documents/work/LandBank/element-plus/packages/components/date-picker/src/date-picker-com/basic-year-table.vue"]]);
