...
declare const _default: import("vue").DefineComponent<{
    ...
    emit: ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string) => void) & ((event: "input", value: string) => void) & ((event: "focus", evt: FocusEvent) => void) & ((event: "blur", evt: FocusEvent) => void) & ((event: "select", item: Record<string, any>) => void) & ((event: "clear") => void);
