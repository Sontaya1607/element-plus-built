...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: contextEmit }) {
    ...
    const timeFormat = vue.computed(() => {
      return utils$1.extractTimeFormat(props.format);
    });
    const dateFormat = vue.computed(() => {
      return utils$1.extractDateFormat(props.format);
    });
    ...
    const formatToString = (value) => {
      const template = props.buddhistEra ? utils.getBuddhistEraFormat(props.format) : props.format;
      if (selectionMode.value === "dates") {
    ...
    const parseUserInput = (value) => {
      const dateStrVal = props.buddhistEra ? utils.parseBuddhistEraUserInputToDayjs(value, props.format) : value;
      const formatStr = props.buddhistEra ? utils.parseBuddhistEraToChristEra(props.format) : props.format;
      return dayjs__default["default"](dateStrVal, formatStr).locale(lang.value);
    };
          ...
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              ...
              currentView.value === "year" ? (vue.openBlock(), vue.createBlock(basicYearTable["default"], {
                ...
                "disabled-date": vue.unref(disabledDate),
                "parsed-value": _ctx.parsedValue,
                "buddhist-era": _ctx.buddhistEra,
                onPick: handleYearPick
              }, null, 8, ["date", "disabled-date", "parsed-value", "buddhist-era"])) : vue.createCommentVNode("v-if", true),
...
var DatePickPanel = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "/Users/sontayarungsaard/Documents/work/LandBank/element-plus/packages/components/date-picker/src/date-picker-com/panel-date-pick.vue"]]);
