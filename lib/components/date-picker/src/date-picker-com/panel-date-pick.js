...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: contextEmit }) {
    ...
    const parseUserInput = (value) => {
      const dateStringValue = props.buddhistEra ? utils.getBuddhistEraStringValue(value, props.format) : value;
      return dayjs__default["default"](dateStringValue, props.format).locale(lang.value);
    };
