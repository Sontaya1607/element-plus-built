  ...
  setup(__props, { emit }) {
    ...
    const parseUserInput = (value) => {
      if (props.buddhistEra) {
        return shared.isArray(value) ? value.map((_) => dayjs__default["default"](utils.getBuddhistEraStringValue(_, format), format).locale(lang.value)) : dayjs__default["default"](utils.getBuddhistEraStringValue(value, format), format).locale(lang.value);
      }
