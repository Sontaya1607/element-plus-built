...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const yearOffset = utils$1.getDayDiffValue(props.buddhistEra);
              ...
              (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(4, (__, j) => {
                return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                  ...
                  i * 4 + j < 10 ? (vue.openBlock(), vue.createElementBlock("td", {
                    ...
                    vue.createElementVNode("span", _hoisted_3, vue.toDisplayString(vue.unref(startYear) + i * 4 + j + vue.unref(yearOffset)), 1)
...
var YearTable = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "/Users/sontayarungsaard/Documents/work/LandBank/element-plus/packages/components/date-picker/src/date-picker-com/basic-year-table.vue"]]);
